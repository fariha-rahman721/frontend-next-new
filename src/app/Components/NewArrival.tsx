            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 justify-center">
                {jewelleries.map((item, index) => (
                    <motion.div
                        ...
                        className="bg-white shadow-lg rounded-xl overflow-hidden cursor-pointer transition-transform hover:scale-105 hover:z-10 relative ml-6 mb-12"
                ...
                {isModalOpen && selectedProduct && (
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                onClick={closeModal}
                                className="absolute top-4 right-4 w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center shadow hover:bg-gold hover:text-white transition-colors"
                            >
                                <X size={20} />
                            </button>
                            ...
                            <div className="flex flex-col md:flex-row">
                                ...
                                <div className="md:w-1/2 w-full p-6 flex flex-col justify-between">
                                    ...
                                    <button
                                        className="mt-4 px-6 py-2 bg-gray-800 text-white font-semibold uppercase rounded hover:bg-gold transition-colors duration-300"
                                    >
                                        Add to Cart
                                    </button>
                                </div>
